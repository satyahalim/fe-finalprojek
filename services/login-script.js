document.getElementById("loginForm").addEventListener("submit", async function (e) {
  ...
  try {
    ...
    const userRes = await fetch("https://projek-be-559917148272.us-central1.run.app/loginuser", {
      method: "POST",
    ...
    const adminRes = await fetch("https://projek-be-559917148272.us-central1.run.app/loginadmin", {
      method: "POST",
      headers: { "Content-Type": "application/json" },
      body: JSON.stringify({ email, pass }),
